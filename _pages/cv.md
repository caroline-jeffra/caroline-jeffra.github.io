...
I'm a backend and platform engineer with varied experience looking to grow professionally through new challenges and in new domains. I'm known for my persistence in tackling tough issues and for looking at the horizon to head off problems before they arise. With my research background, I always love the chance to take a deep dive into topics. 

## Professional Experience

**Software Engineer, Leads.io** *Oct 2025 - Present (Hoorn, NL)*
- Contributed to multiple internal projects, developing features, fixing bugs, improving stability and performance
- Projects include: B2B customer portal for approving assets, internal data platform for ingesting, processing and presenting metrics, asset management platform

**CMS Developer, Leads.io** *Dec 2023 – Oct 2025 (Hoorn, NL)*
...
### [Home Budgeter](https://github.com/caroline-jeffra/home-budgeter) (2026)
- API for handling household monthly budgeting based on an 'allocate to zero' approach
- Features transaction ingest and deduplication, manual and predictive categorization, transaction splitting
- Fully tested, self hosted, and performance monitored API
- Python, FastApi, Alembic, PostgreSQL, Github CI/CD

### [Claudesidion](https://github.com/caroline-jeffra/claudesidion) (2026)
- Claude plugin for capturing indexed, structured history of ongoing development work into structured markdown directories, favoring Obsidian
- Includes skills for compiling personal reports of long term outputs, committing workspace changes to version control, ingesting new projects as workspaces, and tracking progression through longer-effort work
- Bash, Python, Markdown

### [Reconkit](https://github.com/caroline-jeffra/reconkit) (2025 - 2026)
- Python CLI and library of tools for simplifying security checkups of owned sites
- Tools include checks for vulnerable endpoint exposure, error spike detection, and request log sampling
- Python, Google Cloud Console, Cloudflare

### [Container Monitors](https://github.com/caroline-jeffra/container-monitors) (2025 - 2026)
...
### Headless WordPress/Laravel/Vue CMS (2023 - 2025)
